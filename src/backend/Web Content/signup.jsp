...
<body>
	<nav class="navbar navbar-light" style="background-color: #2A0055;">
	  ...
	  <form class="form">
	    ...
	    <input class="form-control mr-sm-2 mb-2 py-1 login-field" required type="search" placeholder="username..." aria-label="Search">
	    <input class="form-control mr-sm-2 mb-2 py-1 login-field" required type="search" placeholder="password..." aria-label="Search">
			...
			<div class="row">
				<div class="column col-sm-6 border-right">
					<div>
						...
						<br>
						<input type="text" name="fname" required class="input-field form-input form-control col-sm-9 py-0 mb-2">
					</div>
					<div>
						<label>Last Name</label>
						<br>
						<input type="text" name="lname" required class="input-field form-input form-control col-sm-9 py-0 mb-2">
					</div>
					<div>
						<label>Email</label>
						<br>
						<input type="text" name="email" required class="input-field form-input form-control col-sm-9 py-0 mb-2">
					</div>
					<div>
						<label>Password</label>
						<br>
						<input type="password" name="password" required class="input-field form-input form-control col-sm-9 py-0 mb-2">
					</div>								
				</div>
				<div class="column ml-auto ">
					<div class="col-sm-12 pl-0">
						...
						<div class="btn-group dropright ml-0">
                            <select name="gender" id="gender" required class="input-field btn btn-secondary col-sm-12 form-control bg-white text-dark py-0 mb-2">
					...
					<div>
						...
						<br>
						<input type="date" name="bday" required class="input-field form-input form-control col-sm-12 py-0 mb-2">
					</div>
					<div>
